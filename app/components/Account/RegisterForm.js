...
export default function RegisterForm(props) {
    ...
    const onSumit = () => {
        if (isEmpty(formData.email) || isEmpty(formData.password) || isEmpty(formData.repeatPassord)) {
    ...
    return (
        <View style={styles.viewContainer}>
            ...
            <Input
                ...
                rightIcon={<Icon type="material-community" iconStyle={styles.iconRight} name={!showPassword ? 'eye-off-outline' : 'eye-outline'}
            ...
            <Input
                ...
                rightIcon={<Icon type="material-community" iconStyle={styles.iconRight} name={!showRepeatPassword ? 'eye-off-outline' : 'eye-outline'}
